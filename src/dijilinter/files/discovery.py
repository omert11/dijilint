...
from dijilinter.types import ParsedFileType, PyprojectConfig
...
class FileDiscovery:
    ...
    def _parse_python_files_from_dir(
        self, dir: str
    ) -> Generator[ParsedFileType, None, None]:
        files = []
...
def load_config(dir: Sequence[str]) -> Optional[PyprojectConfig]:
    ...
    if toml_file:
        ...
        return config.get("tool", {}).get("dijilinter", {})
