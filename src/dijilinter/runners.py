...
from dijilinter.analyzers import BaseAnalyzer, get_analyzer_chain
from dijilinter.filters import FileFilter, GlobalSettings
from dijilinter.fixers import BaseFixer, get_fixers_chain
from dijilinter.processors import Processor
from dijilinter.types import ParsedFilesType
...
class Runner:
    ...
    def analyze(
        self, trees: ParsedFilesType, global_settings: GlobalSettings
    ) -> List[Violation]:
